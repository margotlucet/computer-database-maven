...
public interface ComputerDAO {
	...
	/**
	 * Gets a list of computers in the database in a particular order with a
	 * limit and an offset
	 * 
	 * @param limit
	 * @param offset
	...
	/**
	 * Gets a a list of computers in the database in a particular order with a
	 * limit and an offset containing a particular String
	 * 
	 * @param limit
	 * @param offset
	 * @param orderBy
